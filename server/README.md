...
This project is meant to be use for chekpoint 4. I use [harmonia](https://www.npmjs.com/package/create-harmonia) template, actually in development. This is the opportunity of me to test a lot a things includes this template.
